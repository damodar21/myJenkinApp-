...
<body id="sample">
  <div class="textColumn">
    <h1>Congratulations HA HA HA</h1>
    <p>Your first AWS Elastic Beanstalk Python Application is now running on your own dedicated environment in the AWS Cloud after modification</p>
  </div>
